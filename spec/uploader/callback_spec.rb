...
describe CarrierWave::Uploader do
  ...
  it "should keep callbacks on different classes isolated" do
    ...
    @uploader_class_2._before_callbacks[:cache].should == [:check_whitelist!, :check_blacklist!, :check_content_type_whitelist!, :check_content_type_blacklist!, :process!, :before_cache_callback]
